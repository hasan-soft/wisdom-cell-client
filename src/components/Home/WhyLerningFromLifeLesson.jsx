  ...
  const benefits = [
    {
      ...
      description:
        "Reflecting on experiences increases self-awareness and empathy.",
      color: "text-primary",
      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {benefits.map((benefit) => (
            <div
              key={benefit.id}
              className={`bg-base-200 p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300 ${benefit.border}`}
            >
